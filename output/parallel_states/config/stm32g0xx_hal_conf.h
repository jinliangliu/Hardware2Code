...
/**
  ...
  * @author  Hardware2Code (based on MCD Application Team template)
  * @brief   HAL configuration file generated for STM32G0B1RET6
  ******************************************************************************
  */
...
#define  USE_RTOS                     0U          /* FreeRTOS is used */
