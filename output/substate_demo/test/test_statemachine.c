...
int main(void) {
    ...
    RUN_TEST(test_IDLE_to_PROCESS_on_BUTTON_PRESS);
    RUN_TEST(test_PROCESS_to_IDLE_on_RETURN);
    RUN_TEST(test_PROCESS_to_IDLE_on_RETURN);
